...
const ProgramsLayout = ({ state }) => {
    ...
    const categories = ["All", "Education & Learning", "Digital & Technical Skills", "Employment & Entrepreneurship", "Innovation & Science Engagement", "Holistic Development", "Youth Engagement & Support"];
