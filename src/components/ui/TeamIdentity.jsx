  ...
  return (
    <>
      <div className="volunteer-card">
        <div className="card border-0 shadow-sm h-100 transition-all hover-transform" data-bs-toggle="modal" data-bs-target="#myModal" data-whatever={JSON.stringify(details)}>
          <div className="card-body text-center p-4 d-flex flex-column">
            ...
            <p className="mb-3 flex-grow-1">{details.bio.short}</p>
