...
const Hero = () => {
    return (
        <section className="programs-hero position-relative overflow-hidden py-5">
            {/* Gradient overlay */}
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-10 text-center" data-aos="fade-up">
                        ...
                        <p className="lead text-white mb-5 mx-auto" style={{ maxWidth: "700px" }}>
                            Discover the initiatives through which Durga Foundation is creating a positive impact in our communities
                        </p>
